      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: reduceMotion ? 0 : 0.15 }}
            className={`absolute right-0 top-full mt-2 w-[380px] max-h-[480px] bg-bg/95 backdrop-blur-xl border border-border/60 rounded-xl shadow-2xl ${Z_LAYER.MODAL} overflow-hidden flex flex-col`}
            aria-live="polite"
          >
            {/* Header */}
